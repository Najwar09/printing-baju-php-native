...
$id_tabel1 = $_GET['id'];
$query = "SELECT * FROM tabel1 WHERE id_tabel1 = '$id_tabel1'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Edit tabel 1</h1>
                ...
                <div class="container">
                    <form enctype="multipart/form-data" method="post" action="proses.php?id=edit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="<?= $isi['id_tabel1'];?>" hidden name="id_tabel1">
                        </div>
